...
user in an INI file next to FindAndReplacePortable.exe called FindAndReplacePortable.ini.
...
copy AppNamePortable.ini from this directory to FindAndReplacePortable.ini next to
FindAndReplacePortable.exe. The options in the INI file are as follows:
